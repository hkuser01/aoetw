  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" style="font-size: 18px; line-height: 50px; background: #607D8B;  ">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../units.php">單位</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../tech.php">科技</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../bulding.php">建築</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../Armor_class.php">護甲分類</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../batt.php">戰役</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../starbatt.php">戰術技巧</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../qa.html">常見問題</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../talk.php">討論區</a>
                </li>
    </ul>
  </div>  
</nav>
	<div class="container">
		...
		<div class="navbar">
			<p class="navbar-text navbar-right"><a style=" color: #000; font-size: 22px; " href="login.php">發表記錄檔</a></p>
