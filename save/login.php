				...
				<form class="form-horizontal" role="form" action="login.php" method="post">
				  ...
				  <div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
					  <button type="submit" class="btn btn-default" style=" width: 100%; background: #2b7fc3; " name="send" value="send">登入</button>
					</div>
				  </div>
				</form>
				<p style=" padding: 10px; " class="bg-primary">帳號密碼皆為:aoetw</p>
			</div>
		</div>
	</div>
	<?=$getTmp->setFooter();?>
