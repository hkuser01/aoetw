...
?>
		...
		<form class="form-horizontal" role="form" action="manage.php?p=article_edit&id=<?=$getId;?>" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			<label for="article_author" class="col-lg-2 control-label">平台版本</label>
			<div class="col-lg-10">
			  	<input type="text" class="form-control" id="article_author" name="article_author" placeholder="HD或Voobly" value="<?=$article_author;?>">
			</div>
		  </div>
		  <div class="form-group">
