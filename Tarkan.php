        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              ...
              <li>韃靼騎兵不善於和對方部隊接戰，尤其是像<a href="Teutonic_Knight.php">條頓騎士</a>、<a href="Paladin.php">遊俠</a>、
                <a
                href="Jaguar_Warrior.php">豹勇士</a>等重型單位。而他們緩慢的攻擊動作（揮動火把）也讓他們在攻速上大大不如其他單位。由於匈奴人有<a href="Paladin.php">遊俠</a>，所以最好以
                  <a
                  href="Paladin.php">遊俠</a>當作戰場主力。而韃靼騎兵則搭配<a href="Trebuchet.php">巨型投石機</a>使用才能發揮最大效益。</li>
