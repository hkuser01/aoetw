...
<html lang="zh-tw">
  ...
  <body onload="prettyPrint();" style=" font-family: " 微軟正黑體 ";">
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="img/TarkanIcon.jpg" width="30" alt="">
        <div><a href="Tarkan.php">韃靼騎兵</a>
        </div>
      </td>
      <td class="t13 trm">
      ...
      <td class="t13 trm">
        ...
        <div><a href="Marauders.php">掠奪者</a>
        </div>
      </td>
      <td class="t13 trm"></td>
      <td class="t13 trm"></td>
    ...
    <tr>
      ...
      <img class="gg" src="img/TarkanIcon.jpg" width="30" alt="">
      <div><a href="Tarkan.php">精銳韃靼騎兵</a>
      </div>
      <td class="t13 trm">
