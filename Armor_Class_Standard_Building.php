              ...
              <div class="col-md-12">
                <div class="col-md-4">
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" src="img/ElephantArcherIcon.jpg" alt=""><a href="Elephant_Archer.php">精銳象弓騎兵</a>(<a href="Indians.php">印度</a>限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" src="img/ElephantArcherIcon.jpg" alt=""><a href="Elephant_Archer.php">象弓騎兵</a>(<a href="Indians.php">印度</a>限定)</li>
                    <li>
            ...
            <div class="n1">
              ...
              <ul>
                ...
                <li>
                  <img class="gg" src="img/HuskarlIcon.jpg" alt=""><a href="Huskarl.php">哥德衛隊</a>→
                  <img class="gg" src="img/HuskarlIcon.jpg"
                  alt=""><a href="Huskarl.php">哥德衛隊(精銳)</a>(<a href="Goths.php">哥德</a>限定)</li>
                <li>
                  <img class="gg" src="img/CondottieroNewIcon.jpg" alt=""><a href="Condottiero.php">傭兵</a>(<a href="Italians.php">義大利</a>和同盟限定)</li>
              </ul>
            </div>
              ...
              <div class="n1"><a href="Saracens.php">薩拉森</a>可讓以下單位對標準建築物有額外傷害。
                <div class="n1">
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" width="22" src="img/LongbowmanIcon.jpg" alt=""><a href="Longbowman.php">長弓兵</a> 
                      <img class="gg" width="22" src="img/LongbowmanIcon.jpg"
                      alt=""><a href="Longbowman.php">精銳長弓兵</a>(<a href="Britons.php">不列顛</a>限定)</li>
                    <li>
